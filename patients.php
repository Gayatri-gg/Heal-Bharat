...
<body>
	<div class="container my-md-4 my-0">
		...
		<input type="submit" name="click" value=" Add +" href="dashup3.php" target="home"  style="background-color: #4CAF50;
    border: none;
    color: white;
    padding: 5px 10px;
    text-align: center;
	...
	">
		...
		<th style="font-size:15px;">Delete</th>		
            ...
            <td><a href="view_P.php?id=<?php echo $row['id']; ?>">View Details</a></td>
            <td><a href="edit_patient.php?id=<?php echo $row['id']; ?>">Edit</a></td>
            <td><a href="delete_patient.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this Patient?');">Delete</a></td>
        </tr>
    <?php 
    } 
    ?>
</table>
			<!--<center><h5 id="mytext" style="color:darkblue;">It seems you dont have created any meetings yet!</h5></center>
			<script>
			let a= document.getElementById("mytext").style.display="none";
			</script>-->
</div>			
			</div>
...
if(isset($_POST['click'])){
	echo"<script>window.location.href='add_patient.php'</script>";
}
?>
<?php
