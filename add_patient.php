		...
		<form  method="POST"  class="needs-validation" enctype="multipart/form-data" >
			...
			<div class="form-row">
				...
				<div class="col-12 my-3">
					...
					<input type="text" placeholder="Enter the  Patient Name" class="form-control" id="name" name="name" pattern="[a-zA-Z][a-zA-Z0-9\s]*"required>
			...
			<div class="form-row">
				...
				<div class="col-12 col-md-6 mb-2">
					...
					<input type="number" placeholder="Enter the  Patient Age" class="form-control" id="age" name="age"
						required>
			...
			<div class="form-row">
				<div class="col-12 col-md-6 mb-2">
					<label >Email <span class="text-danger">
							*</span></label>
					<div class="input-group mb-3">
						<input type="email" name="email" id="email" placeholder="Enter the  Patient Email "style="width:514px; height:35px;border-radius:4px;border: 1px grey;	" >
				...
				<div class="input-group mb-3">
					<label >Mobile Number <span class="text-danger">*</span></label>
					 <input type="number" class="form-control" placeholder="Enter the  Patient Mobile no." id="mb" name="mb" style="width:420px; height:35px;border-radius:4px;border: 1px grey;	" >
			...
			<div class="form-row">
				<div class="col-12 my-3" id="jyCustomDonation">
					...
					<div class="input-group mb-3">
						...
						<textarea rows="10" cols="65" name="address" id="address" class="form-control" ></textarea> 
						</div>	
				</div>
			</div>
...
if(isset($_POST['submit'])) {
    ...
    $q = "INSERT INTO `patients`( `name`, `gender`, `age`, `email`, `mb_no`, `address`) VALUES ('$a','$b','$c','$d','$e','$f')";
    
    if(mysqli_query($conn, $q)) {
        echo "
        <script>
            alert('Data inserted successfully');
            window.location.href='patients.php'; // Redirect to a confirmation page or another page
        </script>";
    } else {
