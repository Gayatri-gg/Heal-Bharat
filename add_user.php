		...
		<form  method="POST"  class="needs-validation" enctype="multipart/form-data" >
			...
			<div class="form-row">
				...
				<div class="col-12 my-3">
					...
					<input type="text" placeholder="Enter the User Name" class="form-control" id="name" name="name" pattern="[a-zA-Z][a-zA-Z0-9\s]*"required>
			...
			<div class="form-row">
				...
				<label >Email <span class="text-danger">*</span></label>
					<input type="email" placeholder="Enter the User Email" class="form-control" id="email" name="email" >
				</div>
				<div class="col-12 col-md-6 mb-2">
...
if(isset($_POST['submit'])) {
    ...
    $q = "INSERT INTO `users`( `username`, `email`, `password`, `role`) VALUES ('$a','$b','$c','$d')";
    
    if(mysqli_query($conn, $q)) {
        echo "
        <script>
            alert('Data inserted successfully');
            window.location.href='users.php'; // Redirect to a confirmation page or another page
        </script>";
    } else {
