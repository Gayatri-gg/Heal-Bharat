		...
		<form  method="POST"  class="needs-validation" enctype="multipart/form-data" >
			...
			<div class="form-row">
				...
				<div class="col-12 my-3">
					...
					<input type="text" placeholder="Enter Doctor Name" class="form-control" id="name" name="name" pattern="[a-zA-Z][a-zA-Z0-9\s]*"required>
...
if(isset($_POST['submit'])) {
    $a = $_POST['name'];
    $b = $_POST['specialization'];
    $c = $_POST['time']; 
   
    // Insert data into database
    $q = "INSERT INTO doctors (name, specialization, time) VALUES ('$a', '$b', '$c')";
    
    if(mysqli_query($conn, $q)) {
        echo "
        <script>
            alert('Data inserted successfully');
            window.location.href='doctors.php'; // Redirect to a confirmation page or another page
        </script>";
    } else {
