		...
		<th style="font-size:15px;">Delete</th>
			...
			{			
				...
				<tr>
					...
					<td><a href="edit_specialization.php? id=<?php echo $row['id'];?>">edit</a></td>
				
					<td><a href="delete_specialization.php? id=<?php echo $row['id'];?>"onclick="return confirm('Are you sure you want to delete this specialization?');">delete</a></td>
...
if(isset($_POST['click'])){
	echo"<script>window.location.href='add_specialization.php'</script>";
}
?>
<?php
...
try {
    ...
    $stmt = $pdo->query("SELECT COUNT(*) FROM specialization");
