...
<body>
	<div class="container my-md-4 my-0">
		...
		<th style="font-size:15px;">Sr No.</th>                         <!--color:#097969;-->
		<th style="font-size:15px;">Patient <br>Name</th>
		<th style="font-size:15px;">Doctor <br>Name</th>
		<th style="font-size:15px;">Date</th>
		<th style="font-size:15px;">Time</th>
		<th style="font-size:15px;">Status</th>
		<th style="font-size:15px;">View<br> Details</th>
		...
		<th style="font-size:15px;">Delete</th>		
            ...
            <td><a href="edit_appointment.php?id=<?php echo $row['id']; ?>">Edit</a></td>
            <td><a href="delete_appointment.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this Appointment');">Delete</a></td>
        </tr>
    <?php 
    } 
    ?>
